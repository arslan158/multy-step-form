...
//     // Check for name field: required and minimum 4 characters
//     if (!name.trim()) {
...
//   const progressWidth = (currentStep / totalSteps) * 100; // Calculate progress percentage
...
//         <button 
// className={`bg-green-600 py-2.5 px-10 text-white text-balance font-medium ${currentStep === totalSteps ? 'hidden' : ''} ${showNextBtn && 'hidden'}`}
// onClick={nextStep}
//         >
